...
get_best_span = BidirectionalAttentionFlow._get_best_span
...
def train_epoch(model, train_dataset, validation_dataset,
    ...
    for batch in train_generator:
        ...
        span_accuracy_metric(best_span,
...
def evaluate(model, evaluation_dataset, batch_size, cuda):
    ...
    evaluation_generator = tqdm(
        evaluation_iterator(evaluation_dataset,
                            num_epochs=1, shuffle=False,
                            cuda_device=0 if cuda else -1, for_training=False),
